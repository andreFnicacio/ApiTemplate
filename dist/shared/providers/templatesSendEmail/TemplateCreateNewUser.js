...
// src/shared/providers/templatesSendEmail/TemplateCreateNewUser.ts
var TemplateCreateNewUser_exports = {};
__export(TemplateCreateNewUser_exports, {
  TemplateCreateNewUser: () => TemplateCreateNewUser
});
module.exports = __toCommonJS(TemplateCreateNewUser_exports);
...
// src/shared/providers/templatesSendEmail/TemplateCreateNewUser.ts
var TemplateCreateNewUser = ({ name, email, password }) => `
<div>
...
<p style="padding-bottom: 4px; font-size: 16px;">
  Seja bem vindo a Member area, clicando no bot\xE3o abaixo voc\xEA acessar\xE1 nossa plataforma
</p>
