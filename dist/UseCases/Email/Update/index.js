...
__export(Update_exports, {
  UpdateEmailsControllerIndex: () => UpdateEmailsControllerIndex
});
...
// src/UseCases/Email/Update/index.ts
var UpdateEmailsControllerIndex = new UpdateEmailsController(import_tsyringe2.container.resolve(UpdateEmailsUseCase));
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  UpdateEmailsControllerIndex
});
