...
var GetSents_exports = {};
__export(GetSents_exports, {
  GetSentsEmailsControllerIndex: () => GetSentsEmailsControllerIndex
});
module.exports = __toCommonJS(GetSents_exports);
...
// src/UseCases/Email/GetSents/index.ts
var GetSentsEmailsControllerIndex = new GetSentsEmailsController(import_tsyringe2.container.resolve(GetSentsEmailsUseCase));
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  GetSentsEmailsControllerIndex
});
