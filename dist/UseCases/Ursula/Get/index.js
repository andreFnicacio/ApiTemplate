...
// src/UseCases/Ursula/Get/index.ts
var Get_exports = {};
__export(Get_exports, {
  GetUrsulaControllerIndex: () => GetUrsulaControllerIndex
});
...
var GetUrsulaController = class {
  constructor(GetUrsulaUseCase2) {
    this.GetUrsulaUseCase = GetUrsulaUseCase2;
  }
...
// src/UseCases/Ursula/Get/index.ts
var GetUrsulaControllerIndex = new GetUrsulaController(import_tsyringe2.container.resolve(GetUrsulaUseCase));
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  GetUrsulaControllerIndex
});
