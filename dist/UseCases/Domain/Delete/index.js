...
__export(Delete_exports, {
  DeleteDomainControllerIndex: () => DeleteDomainControllerIndex
});
...
// src/UseCases/Domain/Delete/index.ts
var DeleteDomainControllerIndex = new DeleteDomainController(import_tsyringe2.container.resolve(DeleteDomainUseCase));
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  DeleteDomainControllerIndex
});
