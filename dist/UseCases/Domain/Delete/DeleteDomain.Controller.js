...
var DeleteDomain_Controller_exports = {};
__export(DeleteDomain_Controller_exports, {
  DeleteDomainController: () => DeleteDomainController
});
module.exports = __toCommonJS(DeleteDomain_Controller_exports);
var DeleteDomainController = class {
  constructor(DeleteDomainUseCase) {
