...
var CreateDomain_controller_exports = {};
__export(CreateDomain_controller_exports, {
  CreateDomainController: () => CreateDomainController
});
module.exports = __toCommonJS(CreateDomain_controller_exports);
var CreateDomainController = class {
  constructor(CreateDomainUseCase) {
