...
var UpdateDomain_Controller_exports = {};
__export(UpdateDomain_Controller_exports, {
  UpdateDomainController: () => UpdateDomainController
});
module.exports = __toCommonJS(UpdateDomain_Controller_exports);
var UpdateDomainController = class {
  constructor(UpdateDomainUseCase) {
